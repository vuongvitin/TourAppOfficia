<%-- 
    Document   : tours-stats
    Created on : Oct 19, 2021, 1:41:10 AM
    Author     : PC
--%>
...
<!DOCTYPE html>
<h1 class="text-center text-info">THỐNG KÊ SỐ LƯỢNG ĐẶT TOUR THEO THÁNG</h1>
...
<div>
  <canvas id="myTourStatsChart"></canvas>
</div>
...
<table class="table">
    ...
    <c:forEach items="${toursStats}" var="t">
    <tr>
        <td>${t[0]}/${t[1]}</td>
        <td>${t[2]} lượt</td>
    </tr>
...
<script>
    ...
    window.onload = function(){
        tourNumberBookMonthChart("myTourStatsChart", tourLabels, tourInfo);
    } 
</script>